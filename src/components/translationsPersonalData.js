const translationsPersonalData = {
  sections: [
    ...
    [
      {
        type: 'paragraph',
        content: 'Twoje dane pozostaną w naszym posiadaniu przez okres 12 miesięcy.'
      }
    ],
    [
      {
      ...
      {
        type: 'paragraph',
        content: 'W każdej chwili przysługuje Ci prawo wniesienia sprzeciwu wobec przetwarzania Twoich danych – możesz tego dokonać poprzez przesłanie wiadomości e-mail na adres aleksandra.bis@dareit.org.'
      },
      {
        type: 'paragraph',
