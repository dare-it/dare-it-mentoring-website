const translations = {
  "home": {
    ...
    "about": {
      ...
      "listTitle": "W ramach programu będziesz mogła bezpłatnie zgłębiać wiedzę w wybranym obszarze:",
      "list": [
    ...
    "timeline": {
      ...
      "bottom": {
        ...
        "details": [
          ...
          {
            "items": [
              "Min. 6 indywidualnychsesji mentorskich",
              "Konsultacje HR"
            ]
          },
          {
      ...
      "people": [
        {
          ...
          "info": "Zamieniam pomysły w użyteczne produkty. Lubię pracować ze startupami.",
        ...
        },
        {
          ...
          "info": "Pisze backend aplikacji internetowych.",
    ...
    "faq": {
      ...
      "questions": [
        ...
        {
          "title": "Udział mężczyzn",
          "text": "go for IT jest programem mentoringowym prowadzonym przez kobiety dla kobiet. Jeśli jednak chcesz zgłębiać wiedzę w wymienionych dziedzinach i szukasz mentora, możemy spróbować pomóc i skontaktować Cię z odpowiednią osobą."
        }
      ]
    },
    ...
    "footer": {
      ...
      "title2": "do 23 maja",
      "subtitle": "Pomożemy, jak możemy!",
      "copyright": "lalazdigitala.pl Wszelkie prawa zastrzeżone.",
      "cta": {
        "text": "Aplikuj do programu",
        "link": "/"
      }
